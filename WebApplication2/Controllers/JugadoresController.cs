...
namespace WebApplication2.Controllers
{
    public class JugadoresController : Controller
    {
        ...
        public JugadoresController(WebApplication2Context context)
        {
            _context = context;
        }
        ...
        {
            var webApplication2Context = _context.Jugador.Include(j => j.Equipo);
        ...
        {
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "Id", "Nombre");//Ciudad a nombre
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,posicion,Edad,IdEquipo")] Jugador jugador)
        {
            ...
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "Id", "Nombre", jugador.IdEquipo);//Ciudad anombre
            return View(jugador);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "Id", "Nombre", jugador.IdEquipo);//ciudad a npombre
            return View(jugador);
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,posicion,Edad,IdEquipo")] Jugador jugador)
        {
            ...
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "Id", "Nombre", jugador.IdEquipo);//cambio de ciudad a nombre 
            return View(jugador);
        }
